...
<?
  ...
  if ($upd==1)
	{
	 mysql_query("UPDATE subject SET  subject='$subject' where idsubject=$id");		
	}
else
  {//формирование SQL-запроса на добавление данных
	mysql_query("insert into subject ( subject) values ( '$subject')");
          ...
          <div class="navigation ">
            <nav>
              <ul class="sf-menu">
               ...
               <li class="current"><a href="subject.php">Предметы</a></li>
<?
if ($mode!="")
{
?> 
...
{
$Arr=$_REQUEST["Arr"];
$r=mysql_query("SELECT * FROM subject where idsubject="."$Arr[0]");
...
{
?>
        <h3>Редактирование предмета (режим администратора)</h3>   
<?
}
else
{
?>
        <h3>Добавление предмета (режим администратора)</h3>   
<?
}
?>          
      </div>
...
<form name="form2" method="post"  enctype="multipart/form-data" >
				  <table  border="0" align="">
                    ...
                    <tr>
                      ...
                      <td><input   name="subject"   type="text"  value="<? if ($upd==1) echo "$f[subject]"; else echo(""); ?>" size="40" ></td>
                    </tr>
				...
				<br>
				<input  type="button"  name="button"   onclick="this.form.action='updsubject.php?step=2&upd=<? echo"$upd";?>&id=<? echo"$Arr[0]";?>'; this.form.submit();"   value="OK" width="500">
