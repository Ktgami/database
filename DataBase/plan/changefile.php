...
?>
               <li class="current"><a href="profile.php?iduser=<? echo"$iduser";?>">Профиль</a></li>
<?
}
if ($mode!="")
{
                     ...
                     <tr>
                      ...
                      <td> 
						...
						<input name="file" type="file" size="19" />  
                         <input type="button"  name="button"  value="Загрузить" onClick="this.form.action='changefile.php?iduser=<? echo"$iduser";?>&step=3'; this.form.submit();">
                      </td>
                    </tr> 
		            <tr>
